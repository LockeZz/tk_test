...
class ClaimsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create claim" do
    assert_difference('Claim.count') do
      post claims_url, params: { claim: { amount: @claim.amount, claim_date: @claim.claim_date, claim_name: @claim.claim_name } }
    end
  ...
  test "should update claim" do
    patch claim_url(@claim), params: { claim: { amount: @claim.amount, claim_date: @claim.claim_date, claim_name: @claim.claim_name } }
